...
class CreateNewGraph extends React.Component {
    ...
    render() {
        return (
            <div className="pa4-l">
                <form style={{backgroundColor: '#f2b907'}} className="mw7 center pa4 br2-ns ba b--black-10">
                    <fieldset className="cf bn ma0 pa0">
                        <legend className="pa0 f5 f4-ns mb3 black-80">Enter a name to create new graph</legend>
                        <div className="cf">
                            <input
